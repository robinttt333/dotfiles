...
\name{Robin}{Thakur}
\address{MIG 313 Block Number 25 Sector-4 Parwanoo,Himachal Pradesh India}
\mobile{(+91) 82788-70191}

\email{robinthakur.1897@gmail.com}
% \homepage{www.posquit0.com}
\github{Github.com/robinttt333}
\linkedin{LinkedIn.com/in/robinttt333}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}} % Your expertise/fields
\makecvfooter{}{Robin Thakur~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
