...
{Alerts \scriptsize(\url{ https://github.com/robinttt333/Alerts})} % Organization/group
{Chandigarh} % Location
{July 2018 } % Date(s)
...
\cventry
{Individual} % Affiliation/role
{Canvass \scriptsize(\url{https://github.com/robinttt333/Canvass-frontend})} % Organization/group
{Chandigarh} % Location
...
{Lipreading AI \scriptsize(\url{https://github.com/robinttt333/Lipreader})} % Organization/group
{Chandigarh} % Location
...
\cventry
{Individual} % Affiliation/role
{EigenFaces \scriptsize(\url{https://github.com/robinttt333/EigenFaces})} % Organization/group
{Chandigarh} % Location
